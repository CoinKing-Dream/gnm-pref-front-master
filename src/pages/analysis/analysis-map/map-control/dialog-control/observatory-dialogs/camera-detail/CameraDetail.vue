<template>
  <div>
          ...
          <div class="current-image">
            ...
            >
              <v-carousel-item
                ...
                :key="index"
              >
                <v-img :src="image.url" @click="openOverlay(image)"></v-img>
              </v-carousel-item>
            </v-carousel>
          </div>
        </v-row>
        <div>
          <div class="image-list">
            ...
            >
              ...
              <div class="text">
                <div class="date">{{ getMMDDFormat(image.dateTime) }}</div>
                <div class="time">{{ getHHmmFormat(image.dateTime) }}</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <v-overlay :value="overlay" :opacity="0.8">
      <v-img v-if="overlayImage" :src="overlayImage.url" :width="'100vh'" v-click-outside="onClickOutside"></v-img>
    </v-overlay>
  </div>
</template>
